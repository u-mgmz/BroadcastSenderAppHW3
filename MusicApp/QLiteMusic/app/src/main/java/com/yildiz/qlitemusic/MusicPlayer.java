...
public class MusicPlayer extends AppCompatActivity {
    ...
    Music currentSong;
    MediaPlayer mediaPlayer = MPlayer.getInstance();
    int x=0;
    String albumid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        IntentFilter intentFilter1 = new IntentFilter("com.yildiz.myBroadcastMessage");
    ...
    void setResourcesWithMusic(){
        currentSong = songsList.get(MPlayer.currentIndex);
    ...
    private void playNextSong(){
        ...
        if(MPlayer.currentIndex== songsList.size()-1){
            MPlayer.currentIndex = 0;
            albumid = songsList.get(MPlayer.currentIndex).getAlbum();
            mediaPlayer.reset();
            setResourcesWithMusic();
            return;}
        MPlayer.currentIndex +=1;
        albumid = songsList.get(MPlayer.currentIndex).getAlbum();
        mediaPlayer.reset();
        setResourcesWithMusic();
    ...
    private void playPreviousSong(){
        if(MPlayer.currentIndex== 0){
            MPlayer.currentIndex = songsList.size()-1;
            albumid = songsList.get(MPlayer.currentIndex).getAlbum();
            mediaPlayer.reset();
            setResourcesWithMusic();
            return;
